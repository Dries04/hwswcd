...
#define QOI_CHUNK_ADDRESS       (QOI_CHUNK_BASEADDRESS + 1*4)
#define QOI_CHUNK_ADDRESS       (QOI_CHUNK_BASEADDRESS + 2*4)
#define QOI_CHUNK_ADDRESS       (QOI_CHUNK_BASEADDRESS + 3*4)
